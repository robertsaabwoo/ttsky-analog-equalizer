...
N 2060 310 2060 320 {
lab=Vss}
C {ring_inverter_tune.sym} -220 130 0 0 {name=x1}
...
C {ring_inverter_tune.sym} 230 170 0 0 {name=x2}
...
C {ring_inverter_tune.sym} 660 210 0 0 {name=x3}
...
C {ring_inverter_tune.sym} 1090 250 0 0 {name=x5}
C {ring_inverter_tune.sym} 1500 290 0 0 {name=x4}
...
C {diff_amp_inv_tune.sym} 1850 330 0 0 {name=x6}
